...
class RegisterTypeInt32s(SitModbusRegister):
...
# STATUS SETTING
	...
	def set_value_with_raw(self, a_register_read_res):
		...
		l_v = decoder.decode_32bit_int()
		if l_v == -2147483648: #0x8000 0000
			self._logger.warning('set_value_with_raw-> value is NaN:{}'.format(l_v))
#		else:
#			print('set_value_with_raw->**************************************{}****************'.format(l_v))
