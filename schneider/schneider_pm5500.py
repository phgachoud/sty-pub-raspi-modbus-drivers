...
#			self.__logger.info("register:".join(str(e) for e in result))
	...
	def get_csv_row(self):
		...
		try:
			...
			l_result['U12'] = '{:.2f}'.format(self.register_values_float_32(3020 - 1)) #Phase to phase voltage 1-2
			l_result['U23'] = '{:.2f}'.format(self.register_values_float_32(3022 - 1)) #Phase to phase voltage 2-3
			l_result['U31'] = '{:.2f}'.format(self.register_values_float_32(3024 - 1)) #Phase to phase voltage 3-1
			l_result['V1'] = '{:.2f}'.format(self.register_values_float_32(3028 - 1)) #Simple voltage l1
			l_result['V2'] = '{:.2f}'.format(self.register_values_float_32(3030 - 1)) #Simple voltage l2
			l_result['V3'] = '{:.2f}'.format(self.register_values_float_32(3032 - 1)) #Simple voltage l3
			l_result['F'] = '{:.2f}'.format(self.register_values_float_32(3110 - 1)) #Frequency
			l_result['I1'] = '{:.3f}'.format(self.register_values_float_32(3000 - 1)) #Current l1
			l_result['I2'] = '{:.3f}'.format(self.register_values_float_32(3002 - 1)) #Current l2
			l_result['I3'] = '{:.3f}'.format(self.register_values_float_32(3004 - 1)) #Current l3
			l_result['In'] = '{:.2f}'.format(self.register_values_float_32(3006 - 1)) #Neutral current
			l_result['P'] = '{:.2f}'.format(self.register_values_float_32(3060 - 1)) #Active power kW
			l_result['Q'] = '{:.2f}'.format(self.register_values_float_32(3068 - 1)) #Reactive power kVAR
			l_result['S'] = '{:.2f}'.format(self.register_values_float_32(3076 - 1)) #Apparent power kVAR
			l_result['PF'] = '{:.3f}'.format(self.register_values_float_32_pf(3084 - 1)) #Power factor total
			l_result['P1'] = '{:.2f}'.format(self.register_values_float_32(3054 - 1)) #Active power l1 kW
			l_result['P2'] = '{:.2f}'.format(self.register_values_float_32(3056 - 1)) #Active power l2 kW
			l_result['P3'] = '{:.2f}'.format(self.register_values_float_32(3058 - 1)) #Active power l3 kW
			l_result['Q1'] = '{:.2f}'.format(self.register_values_float_32(3062 - 1)) #Reactive power l1 kVAR
			l_result['Q2'] = '{:.2f}'.format(self.register_values_float_32(3064 - 1)) #Reactive power l2 kVAR
			l_result['Q3'] = '{:.2f}'.format(self.register_values_float_32(3066 - 1)) #Reactive power l3 kVAR
			l_result['S1'] = '{:.2f}'.format(self.register_values_float_32(3070 - 1)) #Apparent power l1
			l_result['S2'] = '{:.2f}'.format(self.register_values_float_32(3072 - 1)) #Apparent power l2
			l_result['S3'] = '{:.2f}'.format(self.register_values_float_32(3074 - 1)) #Apparent power l3
			l_result['PF1'] = '{:.3f}'.format(self.register_values_float_32_pf(3078 - 1)) #Power factor l1 Power Factor phase 1 -: leading and + : lagging : 
			l_result['PF2'] = '{:.3f}'.format(self.register_values_float_32_pf(3080 - 1)) #Power factor l2
			l_result['PF3'] = '{:.3f}'.format(self.register_values_float_32_pf(3082 - 1)) #Power factor l3
			...
			l_result['ThdV1'] = '{:.2f}'.format(self.register_values_float_32(21330 - 1)) #thd V1
			l_result['ThdV2'] = '{:.2f}'.format(self.register_values_float_32(21332 - 1)) #thd V2
			l_result['ThdV3'] = '{:.2f}'.format(self.register_values_float_32(21334 - 1)) #thd V3
			l_result['ThdI1'] = '{:.2f}'.format(self.register_values_float_32(21300 - 1)) #thd I1
			l_result['ThdI2'] = '{:.2f}'.format(self.register_values_float_32(21302 - 1)) #thd I2
			l_result['ThdI3'] = '{:.2f}'.format(self.register_values_float_32(21304 - 1)) #thd I3
...
#
	...
	def register_values_float_32(self, a_register_index):
		...
		if not instance(l_result, float):
			self.__logger.error("register_values_float_32-> result of decode_32bit_float is not a float but:'%s'" % l_result)
			l_result = 0
