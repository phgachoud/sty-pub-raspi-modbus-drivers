...
#			l_result['PF'] = '{:.3f}'.format(self.register_values_float_32_pf()) #Power factor total
			l_result['P1'] = '{:.4f}'.format(self.register_values_float_32(19020)/1000) #Active power l1 W
			l_result['P2'] = '{:.4f}'.format(self.register_values_float_32(19022)/1000) #Active power l2 W
			l_result['P3'] = '{:.4f}'.format(self.register_values_float_32(19024)/1000) #Active power l3 W
			l_result['Q1'] = '{:.2f}'.format(self.register_values_float_32(19028)/1000) #Reactive power l1 VAR
			l_result['Q2'] = '{:.2f}'.format(self.register_values_float_32(19030)/1000) #Reactive power l2 VAR
			l_result['Q3'] = '{:.2f}'.format(self.register_values_float_32(19032)/1000) #Reactive power l3 VAR
			l_result['S1'] = '{:.2f}'.format(self.register_values_float_32(19036)/1000) #Apparent power l1
			l_result['S2'] = '{:.2f}'.format(self.register_values_float_32(19038)/1000) #Apparent power l2
			l_result['S3'] = '{:.2f}'.format(self.register_values_float_32(19040)/1000) #Apparent power l3
